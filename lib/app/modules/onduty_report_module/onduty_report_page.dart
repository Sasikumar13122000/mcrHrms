...
class OndutyReportPage extends GetView<OndutyReportController> {
  @override
  Widget build(BuildContext context)=>GetBuilder<OndutyReportController>(builder: (myController) {
          ...
          child: Column(
            children: [
              Container(
                ...
                child: MyAppBar(screenName: 'Onduty Reports',),
              ),
              Row(
                children: [
                  Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                    width: width/3.5,
                                    child: Text(
                                        controller.secScreenData[index].fROMLOCATION.toString(),
                                        style: const TextStyle(color: Colors.teal,fontWeight: FontWeight.w500)
                                    ),
                                  ),
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                    width: width/3.5,
                                    child: Text(
                                        controller.secScreenData[index].tOLOCATION.toString(),
                                        style: const TextStyle(color: Colors.teal,fontWeight: FontWeight.w500)
                                    ),
                                  ),
